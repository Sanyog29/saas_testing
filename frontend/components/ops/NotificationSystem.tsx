...
interface Notification {
    id: string;
    type: 'ticket_assigned' | 'sla_warning' | 'admin_reminder';
    title: string;
    body: string;
    timestamp: string;
}
                ...
                {notifications.map((notif) => {
                    ...
                    return (
                        <motion.div
                            ...
                            className={`pointer-events-auto flex items-start gap-4 p-4 rounded-xl border bg-white shadow-2xl ${styles.border} ${styles.bg} overflow-hidden relative group`}
                        >
